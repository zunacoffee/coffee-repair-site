                      ...
                      <div className="bg-white rounded-xl border border-black/[0.07] overflow-hidden">
                        ...
                        {showEqForm && (
                          <form onSubmit={handleAddEquipment} className="px-5 py-4 border-b border-black/[0.05] bg-[#E8ECF0]/40 grid grid-cols-2 gap-3">
                            <div>
                              <label htmlFor="eq-type-card" className="block text-xs font-semibold text-[#0D1B2A] mb-1">Type</label>
                              <select id="eq-type-card" value={eqType} onChange={(e) => setEqType(e.target.value)} required className="block w-full rounded-lg border border-black/[0.07] bg-white px-3 py-2 text-sm focus:border-[#B87333] focus:outline-none">
                                <option value="" disabled>Select…</option>
                                <option>Espresso Machine</option><option>Grinder</option><option>Brewer</option><option>Other</option>
                              </select>
                            </div>
                            <div>
                              <label htmlFor="eq-brand-card" className="block text-xs font-semibold text-[#0D1B2A] mb-1">Brand</label>
                              <input id="eq-brand-card" type="text" value={eqBrand} onChange={(e) => setEqBrand(e.target.value)} required placeholder="e.g. La Marzocco" className="block w-full rounded-lg border border-black/[0.07] bg-white px-3 py-2 text-sm focus:border-[#B87333] focus:outline-none" />
                            </div>
                            <div>
                              <label htmlFor="eq-model-card" className="block text-xs font-semibold text-[#0D1B2A] mb-1">Model</label>
                              <input id="eq-model-card" type="text" value={eqModel} onChange={(e) => setEqModel(e.target.value)} required placeholder="e.g. Linea Mini" className="block w-full rounded-lg border border-black/[0.07] bg-white px-3 py-2 text-sm focus:border-[#B87333] focus:outline-none" />
                            </div>
                            <div>
                              <label htmlFor="eq-serial-card" className="block text-xs font-semibold text-[#0D1B2A] mb-1">Serial <span className="font-normal">(optional)</span></label>
                              <input id="eq-serial-card" type="text" value={eqSerial} onChange={(e) => setEqSerial(e.target.value)} placeholder="SN…" className="block w-full rounded-lg border border-black/[0.07] bg-white px-3 py-2 text-sm focus:border-[#B87333] focus:outline-none" />
                            </div>
